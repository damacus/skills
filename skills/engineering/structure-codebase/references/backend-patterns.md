...
This example does not claim a protected hexagon. Enforce cross-context public APIs and language boundaries without manufacturing adapters or port interfaces. Use the repository's DDD guidance for context discovery and modeling rules when it has explicitly adopted DDD.
